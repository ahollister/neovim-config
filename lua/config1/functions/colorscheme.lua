...
M.set_keymaps = function()
	vim.keymap.set(
		"n",
		"<leader>cc",
		":lua require('config1.functions.colorscheme').cycle_colors()<CR>",
		{ silent = false }
	)
	vim.keymap.set(
		"n",
		"<leader>cd",
		":lua require('config1.functions.colorscheme').set_default()<CR>",
		{ silent = true }
	)
	vim.keymap.set(
		"n",
		"<leader>cb",
		":lua require('config1.functions.colorscheme').cycle_backgrounds()<CR>",
		{ silent = true }
	)
	vim.keymap.set(
		"n",
		"<leader>ct",
		":lua require('config1.functions.colorscheme').toggle_transparency()<CR>",
		{ silent = true }
	)
end
